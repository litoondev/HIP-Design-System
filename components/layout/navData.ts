...
export const navLinks: NavLink[] = [
  ...
  { label: "Spacing — Primitives", href: "/#spacing-primitives", group: "Foundations" },
  { label: "Responsive Spacing & Layout", href: "/#responsive-rules", group: "Foundations" },
  { label: "Icon Size", href: "/#icon-sizes", group: "Foundations" },
  ...
  { label: "Top Menu", href: "/#top-menu", group: "Components" },
