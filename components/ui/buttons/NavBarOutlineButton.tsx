import styles from "./NavBarOutlineButton.module.css";
import { typographyClass } from "@/components/ui/typography/Typography";
import { defaultCta, type PracticeType } from "./ctaLanguage";

export interface NavBarOutlineButtonProps {
  label?: string;
...
/**
 * Nav Bar Outline Button — square nav-menu CTA (Figma "HIP Master V3" node 15916:55735, row 1).
 * Navy fill by default; on hover it inverts to a transparent fill with a navy border and navy
 * label — the outline hover treatment.
 */
export default function NavBarOutlineButton({
  label,
  practice,
  href = "#",
  className,
  ground = "light",
}: NavBarOutlineButtonProps) {
