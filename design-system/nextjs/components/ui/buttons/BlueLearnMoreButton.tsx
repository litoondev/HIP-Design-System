import styles from "./BlueLearnMoreButton.module.css";

export interface BlueLearnMoreButtonProps {
  label?: string;
  href?: string;
  className?: string;
}
...
export default function BlueLearnMoreButton({
  label = "LEARN MORE",
  href = "#",
  className,
}: BlueLearnMoreButtonProps) {
  return (
    <a
